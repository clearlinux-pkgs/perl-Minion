...
Version  : 10.29
Release  : 66
URL      : https://cpan.metacpan.org/authors/id/S/SR/SRI/Minion-10.29.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/S/SR/SRI/Minion-10.29.tar.gz
Summary  : 'Job queue'
...
%prep
%setup -q -n Minion-10.29
cd %{_builddir}/Minion-10.29
pushd ..
cp -a Minion-10.29 buildavx2
popd
