...
Source0  : https://cpan.metacpan.org/authors/id/S/SR/SRI/Minion-10.0.tar.gz
Summary  : 'Job queue'
...
%prep
%setup -q -n Minion-10.0
cd %{_builddir}/Minion-10.0
...
cp %{_builddir}/Minion-10.0/LICENSE %{buildroot}/usr/share/package-licenses/perl-Minion/2f8018a02043ed1a43f032379e036bb6b88265f2
if test -f Makefile.PL; then
